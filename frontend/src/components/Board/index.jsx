...
const TaskColumn = ({
    ...
    const handleSetValue = (userValue) => {
        if (!value.includes(userValue)) {
            ...
            setValue(value.filter((val) => val !== userValue));
        }
            ...
            <div className='mb-3 flex w-full'>
                ...
                <div className='flex w-full items-center justify-between rounded-e-lg bg-gray-50 px-5 py-4 dark:bg-dark-secondary '>
                    ...
                    <div className='flex items-center gap-1'>
                        ...
                        <button onClick={() => setIsModalOpen(true)} className='flex h-6 w-6 items-center justify-center rounded bg-gray-200 dark:bg-dark-teritiary dark:text-white'>
                            <Plus size={16} />
                        </button>
...
const Task = ({ task }) => {
    ...
    const formattedStartDate = task.startDate ? format(new Date(task.startDate)) : "";
    const formattedDueDate = task.dueDate ? format(new Date(task.dueDate)) : "";
    ...
    return (
        <div ref={drag} className={`mb-4 rounded-md bg-gray-50 shadow dark:bg-dark-secondary ${isDragging ? "opacity-50" : "opacity-100"
            }`}>
